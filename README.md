...
Public uptime monitor and status page for [Tough Talks](https://toughtalks.ai), powered by [Upptime](https://upptime.js.org). Checks run every 5 minutes via GitHub Actions; data is committed to this repo and rendered as a static site on GitHub Pages.

Live status page: **https://status.toughtalks.ai**

<!--end: description-->

[![Uptime CI](https://github.com/friedbeef1/toughtalks-status/workflows/Uptime%20CI/badge.svg)](https://github.com/friedbeef1/toughtalks-status/actions?query=workflow%3A%22Uptime+CI%22)
[![Response Time CI](https://github.com/friedbeef1/toughtalks-status/workflows/Response%20Time%20CI/badge.svg)](https://github.com/friedbeef1/toughtalks-status/actions?query=workflow%3A%22Response+Time+CI%22)
[![Graphs CI](https://github.com/friedbeef1/toughtalks-status/workflows/Graphs%20CI/badge.svg)](https://github.com/friedbeef1/toughtalks-status/actions?query=workflow%3A%22Graphs+CI%22)
[![Static Site CI](https://github.com/friedbeef1/toughtalks-status/workflows/Static%20Site%20CI/badge.svg)](https://github.com/friedbeef1/toughtalks-status/actions?query=workflow%3A%22Static+Site+CI%22)
[![Summary CI](https://github.com/friedbeef1/toughtalks-status/workflows/Summary%20CI/badge.svg)](https://github.com/friedbeef1/toughtalks-status/actions?query=workflow%3A%22Summary+CI%22)

## [📈 Live Status](https://status.toughtalks.ai): <!--live status--> **🟩 All systems operational**
